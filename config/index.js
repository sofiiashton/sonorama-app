...
//   spotifyButtonFill: "#1CD760",
//   spotifyButtonStroke: "#8FF2B3",
//   cardBackground: "rgba(237, 136, 17, 0.2)",
...
export const Language = {
  ...
  ukrainian: {
    loginWelcomeTitle: "Welcome to Sonorama!",
    loginWelcomeParagraph:
      "Мобільний додаток для знаходження нової музики та створення плейлістів під ваші смаки та настрій.",
    ...
    homePlaylistGenParagraph:
      "Згенеруйте плейліст за вашим настроєм та вподобаннями.",
